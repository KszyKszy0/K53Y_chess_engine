...
class MoveGenerator
{
    ...
    void addPawnWhiteEnpassant(vector<Move>& movesList, Position& pos, Bitboard target); //wazne
    ...
    void addPawnBlackEnpassant(vector<Move>& movesList, Position& pos, Bitboard target); //wazne
